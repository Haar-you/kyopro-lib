...
# :x: test/aoj/2559/main.skew_heap.test.cpp
...
* :x: <a href="../../../../library/Mylib/DataStructure/Heap/skew_heap.cpp.html">Skew heap</a>
...
int main(){
  ...
  if((int)res.size() == n - 1){
    ...
    std::vector<SkewHeap<std::tuple<int64_t, int, int>, std::greater<>>> heaps(n);
