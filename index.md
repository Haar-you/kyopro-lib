...
data:
  ...
  - name: test/yosupo-judge/binomial_coefficient
    pages:
    - icon: ':x:'
  ...
  - name: test/yosupo-judge/chromatic_number
    pages:
    - icon: ':x:'
  ...
  - name: test/yosupo-judge/find_linear_recurrence
    pages:
    - icon: ':x:'
  ...
  - name: test/yosupo-judge/matrix_product
    pages:
    - icon: ':x:'
  ...
  - name: test/yosupo-judge/nim_product_64
    pages:
    - icon: ':x:'
  ...
  - name: test/yosupo-judge/sum_of_exponential_times_polynomial_limit
    pages:
    - icon: ':x:'
