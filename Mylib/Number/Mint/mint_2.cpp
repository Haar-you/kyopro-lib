...
public:
  ...
  constexpr auto& operator=(const modint2 &a){val_ = a.val_; return *this;}
  constexpr auto& operator+=(const modint2 &a){val_ ^= a.val_; return *this;}
  constexpr auto& operator-=(const modint2 &a){val_ ^= a.val_; return *this;}
  constexpr auto& operator*=(const modint2 &a){val_ &= a.val_; return *this;}
  constexpr auto& operator/=(const modint2 &a){val_ &= a.val_; return *this;}
  ...
  friend std::istream& operator>>(std::istream &s, modint2 &a){s >> a.val_; return s;}
  friend std::ostream& operator<<(std::ostream &s, const modint2 &a){s << a.val_; return s;}
