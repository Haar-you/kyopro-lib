...
data:
  ...
  bundledCode: "#line 1 \"test/yosupo-judge/partition_function/main.fps.test.cpp\"\
    ...
    \ == 1) {\n          ok = false;\n          break;\n        }\n      }\n\n   \
    \   if (not ok) continue;\n\n      return g;\n    }\n    return -1;\n  }\n}  //\
    \ namespace haar_lib\n#line 11 \"test/yosupo-judge/partition_function/main.fps.test.cpp\"\
  ...
  code: "#define PROBLEM \"https://judge.yosupo.jp/problem/partition_function\"\n\n\
    ...
    \ prim_root, 1 << 20>;\nconst static auto ntt   = NTT();\nusing FPS          \
    \     = hl::formal_power_series<mint, ntt>;\n\nint main() {\n  std::cin.tie(0);\n\
    \  std::ios::sync_with_stdio(false);\n\n  int N;\n  std::cin >> N;\n\n  auto ans\
    \ = hl::partition_number_fps<FPS>(N);\n  std::cout << hl::join(ans.begin(), ans.begin()\
    \ + (N + 1)) << \"\\n\";\n\n  return 0;\n}\n"
  dependsOn:
...
layout: document
redirect_from:
- /verify/test/yosupo-judge/partition_function/main.fps.test.cpp
- /verify/test/yosupo-judge/partition_function/main.fps.test.cpp.html
