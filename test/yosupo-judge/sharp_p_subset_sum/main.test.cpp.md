...
data:
  ...
  bundledCode: "#line 1 \"test/yosupo-judge/sharp_p_subset_sum/main.test.cpp\"\n#define\
    \ PROBLEM \"https://judge.yosupo.jp/problem/sharp_p_subset_sum\"\n\n#include <iostream>\n\
    ...
    \ 3 \"Mylib/Typical/SubsetSumProblem/subset_sum_count_fps.cpp\"\n\nnamespace haar_lib\
    \ {\n  template <typename Fps>\n  auto subset_sum_count_fps(std::vector<int> s,\
    ...
    \ s = hl::input_vector<int>(N);\n\n  auto ntt = NTT();\n  FPS::convolve = std::bind(&NTT::convolve<mint>,\
    \ &ntt, _1, _2);\n\n  auto ans = hl::subset_sum_count_fps<FPS>(s, T);\n\n  std::cout\
    \ << hl::join(ans.begin() + 1, ans.begin() + T + 1) << \"\\n\";\n\n  return 0;\n\
    }\n\n"
...
layout: document
redirect_from:
- /verify/test/yosupo-judge/sharp_p_subset_sum/main.test.cpp
- /verify/test/yosupo-judge/sharp_p_subset_sum/main.test.cpp.html
