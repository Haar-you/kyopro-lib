...
data:
  ...
  bundledCode: "#line 1 \"test/aoj/CGL_1_A/main.test.cpp\"\n#define PROBLEM \"http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=CGL_1_A\"\
    ...
    \ {\n  template <typename T>\n  point<T> projection(const line<T> &l, const point<T>\
    ...
    \ 10 \"test/aoj/CGL_1_A/main.test.cpp\"\n\nnamespace hl = haar_lib;\n\nstatic\
  ...
  code: "#define PROBLEM \"http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=CGL_1_A\"\
    ...
    \ = hl::double_eps<double, eps>;\n\nint main(){\n  hl::point<D> p1, p2; std::cin\
    \ >> p1 >> p2;\n  hl::line<D> l(p1, p2);\n\n  int q; std::cin >> q;\n\n  for(auto\
    \ [p] : hl::input_tuples<hl::point<D>>(q)){\n    auto ans = hl::projection(l,\
    \ p);\n    std::cout << std::fixed << std::setprecision(12) << ans.x << \" \"\
    \ << ans.y << std::endl;\n  }\n\n  return 0;\n}\n"
  dependsOn:
  - Mylib/Geometry/Float/geometry_template.cpp
  ...
  verifiedWith: []
documentation_of: test/aoj/CGL_1_A/main.test.cpp
layout: document
redirect_from:
- /verify/test/aoj/CGL_1_A/main.test.cpp
- /verify/test/aoj/CGL_1_A/main.test.cpp.html
